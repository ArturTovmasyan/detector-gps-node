...
function saveStatistic(gpsData)
{
    ...
    sequelize.transaction(function(t) {
        ...
        for(var i = sectionPartOrder1; i < sectionPartOrder2 - 1; i++) {
            console.log(gpsData.route_id, ' route section parts between ', sectionPartId1, '__', sectionPartId2, sectionPartOrders[i].id);
            rawStatistic.create({
        ...
        console.log(gpsData.route_id, ' route section parts between ', sectionPartId1, '__', sectionPartId2, sectionPartOrders[sectionPartOrder2 - 1].id);
