...
/**
 * @param routeId
 * @param sectionPartId1 currentBusPosition
 * @param sectionPartId2 frontBusPosition
...
function getTimeStatistics(routeId, sectionPartId1, sectionPartId2) {
    ...
    console.log("sectionPartOrder1: ", sectionPartOrder1, "sectionPartOrder2: ", sectionPartOrder2, "  ", sectionPartStatistic[sectionPartOrder2], "  ",  sectionPartStatistic[sectionPartOrder1]);

    var stopTimes = {};
    var passTime = 0;
    for (var i = sectionPartOrder1; i < sectionPartOrder2; i++){
        if (sectionPartStatistic[i].stop_id && sectionPartStatistic[i].stop_id != sectionPartStatistic[sectionPartOrder1].stop_id && sectionPartStatistic[i].stop_id != sectionPartStatistic[sectionPartOrder2].stop_id){
        ...
        passTime += sectionPartStatistic[i].pass_time;
    }
