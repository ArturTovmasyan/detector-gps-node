        ...
        .then(function(routeIds) {
            ...
            setTimeout(function() {
                for(var imei in lineBuses) {
                    ...
                    sequelize.query("SELECT i.imei, i.route_id, i.timestamp, i.section_part_id, ssp.stop_id, " + lineBuses.length + " as bus_count " +
                        "FROM gps_data AS i " +
                        ...
                        .then(function (result) {
                            ...
                            console.log(allCount, item.bus_count);
                            if (allCount == item.bus_count) {
