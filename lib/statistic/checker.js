                                ...
                                for (var k = 0; k < result.length; k++) {
                                    ...
                                    if (item.stop_id) {
                                        try {
                                            ...
                                            if (Math.abs(statCoeff.passTime - (item.timestamp - firstItem.timestamp) / 1000) == Infinity){
                                                console.log(' from : ', firstItem.timestamp, ' to: ', item.timestamp, ' statCoeff.passTime ', statCoeff.passTime, coeff);
                                            }
