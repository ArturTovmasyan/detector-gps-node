...
function determineRoute(imei, currentSectionId)
{
    ...
    //TODO:*****************************************************************************
    winston.loggers.add(imei, {
        file: {
            level:    'debug',
            filename: 'logs/' + imei + '.log'
        }
    });
    logger = winston.loggers.get(imei);
    logger.error("currentSectionId " + currentSectionId);
    //TODO:*****************************************************************************
    ...
    //TODO:*****************************************************************************
    logger.error("offLineDataCount " + routeSectionOrder[imei]['offLineDataCount']);
    logger.error("onSameSectionCount " + routeSectionOrder[imei]['onSameSectionCount']);
    //TODO:*****************************************************************************
...
function collectBusPlaces(imei, currentSectionId)
{
    ...
    sections[currentSectionId].route_section.forEach(function (routeSection) {
        ...
        logger = winston.loggers.get(imei);
        logger.error(routeSectionOrder[imei][routeSection.route.id]['orderSequence']);
        consoel.log(routeSectionOrder[imei][routeSection.route.id]['orderSequence']);
        //TODO:*****************************************************************************
