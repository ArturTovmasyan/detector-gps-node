...
var gpst1 = GpsData.build({'imei': 5555, 'timestamp': new Date(), 'priority': 1, 'longitude': 40.5555, 'latitude': 44.222252,
    'altitude': 5, 'angle': 256, 'satellites': 9, 'speed': 46, 'statistic_mode_code': 'ss',
    'section_part_id': 11225, 'route_id': 8});

var gpst2 = GpsData.build({'imei': 5555, 'timestamp': new Date(), 'priority': 1, 'longitude': 40.5555, 'latitude': 44.222252,
    'altitude': 5, 'angle': 256, 'satellites': 9, 'speed': 46, 'statistic_mode_code': 'ss',
    'section_part_id': 11225, 'route_id': 8});
