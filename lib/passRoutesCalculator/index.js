                ...
                .then(function (results) {
                    ...
                    for (var im in busesRoutes) {
                        for (var num in busesRoutes[im]) {
                            console.log(busesRoutes[im][num]);
                            if (busesRoutes[im][num][1] > 10 && busesRoutes[im][num][2] > 10 && busesRoutes[im][num][3] > 10 && busesRoutes[im][num][4] > 10
                                && (!busesRoutes[imei][busesRoutes[imei].lastRouteNumber].end_data_before_timestamp || busesRoutes[imei][busesRoutes[imei].lastRouteNumber].end_data_before_timestamp < 10)) {
                                BusRoutes.build({
                                    imei: im,
