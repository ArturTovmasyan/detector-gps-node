...
$(document).ready(function(){
    ...
    socket
        ...
        .on('message',function(msg){
            ...
            var route_0     = msg.busInfo.routes && msg.busInfo.routes[0] ? msg.busInfo.routes[0].id : 0;
            var route_1     = msg.busInfo.routes && msg.busInfo.routes[1] ? msg.busInfo.routes[1].id : 0;
            ...
            if(!markers[gpsData.imei]) {
                var marker = new google.maps.Marker({
                    position: pos,
                    title:    '<div style="font_size=9">imei:' + gpsData.imei + '\nlineNumber:' + msg.busInfo.lineNumber + '\nplateNumber:' + msg.busInfo.plateNumber + '</div>',
                    icon:     busIcon
                });
                marker.setMap(map);
