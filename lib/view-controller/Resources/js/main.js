            ...
            for (var k in msgs) {
                ...
                if (!markers[gpsData.imei]) {
                    ...
                    google.maps.event.addListener(marker, 'click', function() {
                        if (markers[marker.frontImei]) {
                            markers[marker.frontImei].setAnimation(google.maps.Animation.BOUNCE);
                        }
                        if (markers[marker.backImei]) {
                            markers[marker.backImei].setAnimation(google.maps.Animation.BOUNCE);
                        }
                    });
                    ...
                    markers[gpsData.imei].setAttribute('frontImei', msg.busInfo.frontImei);
                    markers[gpsData.imei].setAttribute('backImei',  msg.busInfo.backImei);
