    ...
    var netServer = net.createServer(function (socket) {
        ...
        socket.on('data', function (data) {
            ...
            if (data.readInt16BE(0) === 15) {
                ...
                ipIMEI[socket.key] = data.toString();
            }
                ...
                console.log('gps controller ___ :' + busInfo.data[busInfo.data.length - 1]);
                eventEmitter.emit('data', {IMEI: busInfo.IMEI, data: busInfo.data[busInfo.data.length - 1]});
            }
        });
