 ...
 * @param l
 */
function loadVectorPart(l){
    client.get(loader_conf.host + "/api/vectorparts/" + l + "/line", function (data) {
        module.exports.vector_parts_by_line[l] = data;
...
function loadVectorParts(){
    client.get(loader_conf.host + "/api/line/with/imei", function(data){
        ...
        for(var i = 0; i < data.length; i++){
            ...
            if(lines.indexOf(data[i].lineId) === -1){
                lines.push(data[i].lineId)
            }
        }
