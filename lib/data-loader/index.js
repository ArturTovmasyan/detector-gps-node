...
function getSectionPartsOrders(routeId) {
    ...
    if (!section_parts_order_event[routeId]) {
        ...
        console.log(routeId, ' section part order start loading ', new Date());
        ...
        .then(function (results) {
            ...
            console.log(routeId, ' section part order end loading ', new Date());
        })
        .error(function(err) {
...
function getSectionPartsStatistic(routeId) {
    ...
    if (sectionPartsStatistic[routeId] && sectionPartsStatistic[routeId].length) {
        return sectionPartsStatistic[routeId];
    }

    if (!section_parts_statistic_event[routeId]) {

        console.log(routeId, ' statistic start loading ', new Date());
            ...
            sequelize.query("set @order=0;").then(function(result) {
                sequelize.query("set @order1=0;").then(function(result) {
                    ...
                    .then(function (results) {
                        ...
                        console.log(routeId, ' statistic end loading ', new Date());
                    })
                    .error(function(err) {
                        console.error(err.message);
                    });
    ...
    throw new Error(routeId + " Section part statistic yet didn't loaded");
}
