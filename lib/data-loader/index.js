 ...
 * @returns {Array}
 */
function getSectionPartsOrders() {

    if (sectionPartsOrders.length) {
 ...
 * @returns {Array}
 */
function getSectionPartsStatistic() {

    if (sectionPartsStatistic.length) {
