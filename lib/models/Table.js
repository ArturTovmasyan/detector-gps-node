...
var commands = {
    ...
    'archive:table:addSectionAndRouteIds': {
    "run": addSectionAndRouteIds,
        description: "This command is used to add new columns in the archive table"
    }
};
...
function addSectionAndRouteIds(flags, errorCallback)
{
    var sequelize = models.sequelize;
    var query = sequelize.query(
        "ALTER TABLE gps_info ADD section_part_id INT NULL DEFAULT NULL, " +
        "ADD route_id INT NULL DEFAULT NULL;"
    );
